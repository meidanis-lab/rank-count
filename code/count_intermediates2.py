...
"""Script to count the number of intermediates to sort one genome into
another, given the sizes of the breakpoint graph components.
"""
...
if __name__ == '__main__':
    ...
    print(count_intermediates(paths = k_paths, cycles = k_cycles))
